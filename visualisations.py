...
class FeatureReviewVisualisation:
    ...
    def create_line_plot(self):
        ...
        '''self.data[f'{self.feature_name}_Review_Date'] = (self.data[f'{self.feature_name}_Review_Date']
                                                         .apply(lambda x: today - pd.DateOffset(months=int(x))))
        self.data[f'{self.feature_name}_Review_Date'] = pd.to_datetime(
            self.data[f'{self.feature_name}_Review_Date'])'''
